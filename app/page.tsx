        ...
        <div className="p-5 md:p-7 lg:p-8 grid gap-6 md:grid-cols-2 md:items-start">
          <section className="space-y-4 md:space-y-5">
            <div className="bg-slate-50 p-4 md:p-5 rounded-xl border border-slate-200/80">
              <h2 className="text-[11px] md:text-xs font-bold text-slate-400 uppercase tracking-wider">Sunday Schedule</h2>
              ...
              <p className="mt-2 text-[11px] md:text-xs text-slate-500">{WARD_CONFIG.buildingAddress}</p>
            </div>
          ...
          <section className="space-y-4 md:space-y-5">
            ...
            <div className="space-y-2.5">
              <h2 className="text-[11px] md:text-xs font-bold text-slate-400 uppercase tracking-wider">Official Channels</h2>
            ...
            <div className="pt-2 border-t border-slate-100">
              <h2 className="text-[11px] md:text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Direct Contact</h2>
              <div className="grid grid-cols-2 gap-2.5">
                {WARD_CONFIG.leadership.map((leader) => (
                  <a
                  ...
                  >
                    <p className="text-xs md:text-sm font-bold text-slate-800">{leader.name}</p>
                    <p className="text-[10px] md:text-xs text-indigo-600 font-medium">{leader.role}</p>
                  </a>
                ))}
              </div>
            </div>
